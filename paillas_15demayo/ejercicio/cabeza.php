...
$descripcion_index = "Datos
";
$descripcion_estudiantes = "Datos sobre los estudiantes.";
$descripcion_profesores = "Datos sobre los profesores. ";
?>
<head>
<meta charset="utf-8">
...
<?php if((basename($_SERVER['PHP_SELF']))=='index.php'){?>
  ...
  <?php }else{ ?>
    ...
    <h2><?php echo($descripcion_profesores);?></h2>
